...
static SRes BraState_Code(void *pp, Byte *dest, Size_T *destLen, const Byte *src, Size_T *srcLen,
    int srcWasFinished, ECoderFinishMode finishMode, int *wasFinished)
{
  CBraState *p = ((CBraState *)pp);
  Size_T destLenOrig = *destLen;
  Size_T srcLenOrig = *srcLen;
  *destLen = 0;
  *srcLen = 0;
...
static SRes SbState_Code(void *pp, Byte *dest, Size_T *destLen, const Byte *src, Size_T *srcLen,
    int srcWasFinished, ECoderFinishMode finishMode, int *wasFinished)
{
  CSbDec *p = (CSbDec *)pp;
  SRes res;
...
static SRes Lzma2State_Code(void *pp, Byte *dest, Size_T *destLen, const Byte *src, Size_T *srcLen,
    int srcWasFinished, ECoderFinishMode finishMode, int *wasFinished)
{
  ELzmaStatus status;
...
SRes XzUnpacker_Code(CXzUnpacker *p, Byte *dest, Size_T *destLen,
    const Byte *src, Size_T *srcLen, int finishMode, ECoderStatus *status)
{
  Size_T destLenOrig = *destLen;
  Size_T srcLenOrig = *srcLen;
  *destLen = 0;
  ...
  *status = CODER_STATUS_NOT_SPECIFIED;
  for (;;)
  {
    Size_T srcRem = srcLenOrig - *srcLen;

    if (p->state == XZ_STATE_BLOCK)
    {
      Size_T destLen2 = destLenOrig - *destLen;
      Size_T srcLen2 = srcLenOrig - *srcLen;
      SRes res;
