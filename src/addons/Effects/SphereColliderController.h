...
namespace Demi
{
    class DEMI_FX_API DiSphereColliderController : public DiBaseColliderController
    {
    public:
    ...
    class DEMI_FX_API DiSphereColliderControllerFactory : public DiParticleControllerFactory
    {
    public:
