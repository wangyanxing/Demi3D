...
namespace Demi
{
    class DEMI_FX_API DiLinearForceController : public DiBaseForceController
    {
    public:
    ...
    class DEMI_FX_API DiLinearForceControllerFactory : public DiParticleControllerFactory
    {
    public:
