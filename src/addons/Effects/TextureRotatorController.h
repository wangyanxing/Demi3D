...
namespace Demi
{
    class DEMI_FX_API DiTextureRotatorController : public DiParticleController
    {
    public:
        // Constants
    ...
    class DEMI_FX_API DiTextureRotatorControllerFactory : public DiParticleControllerFactory
    {
    public:
