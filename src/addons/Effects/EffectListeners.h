...
namespace Demi
{
    class DEMI_FX_API DiElementListener
    {
    public:
    ...
    class DEMI_FX_API DiParticleSystemListener
    {
    public:
        ...
        virtual void HandleParticleSystemEvent(DiParticleSystem* particleSystem, ParticleUniverseEvent& particleUniverseEvent) = 0;
    };
}
