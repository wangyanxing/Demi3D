...
namespace micropather
{
	...
	*/
	class Graph
	{
	  public:
		...
		*/	
        virtual void AdjacentCost(void* state, micropather::MPVector< micropather::StateCost > *adjacent) = 0;
	...
	*/
	...
	public:
		...
		// the pather is doing.
        void AllStates(unsigned frame, micropather::MPVector< void* >* stateVec);
	...
	class MicroPather
	{
	  ...
	  public:
		...
		*/
        ...
        void GetCacheData(micropather::CacheData* data);
