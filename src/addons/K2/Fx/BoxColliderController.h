...
namespace Demi
{
    class DEMI_K2_API DiBoxColliderController : public DiBaseColliderController
    {
    public:
    ...
    class DEMI_K2_API DiBoxColliderControllerFactory : public DiParticleControllerFactory
    {
    public:
