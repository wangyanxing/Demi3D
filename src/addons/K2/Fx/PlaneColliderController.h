...
namespace Demi
{
    class DEMI_K2_API DiPlaneColliderController : public DiBaseColliderController
    {
    public:
    ...
    class DEMI_K2_API DiPlaneColliderControllerFactory : public DiParticleControllerFactory
    {
    public:
