...
namespace Demi
{
    class DEMI_K2_API DiRandomiserController : public DiParticleController
    {
    public:
    ...
    class DEMI_K2_API DiRandomiserControllerFactory : public DiParticleControllerFactory
    {
    public:
