...
namespace Demi
{
    class DEMI_K2_API DiGeometryRotatorController : public DiParticleController
    {
    public:
    ...
    class DEMI_K2_API DiGeometryRotatorControllerFactory : public DiParticleControllerFactory
    {
    public:
