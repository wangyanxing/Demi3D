    ...
    */
    ...
    public:
        ...
        */
        ...
        @remarks
            'src' must be aligned and assumed to have enough memory for ARRAY_PACKED_REALS DiVec3
            i.e. on SSE2 you can construct src as:
                DEMI_ALIGNED_DECL( float, vals[ARRAY_PACKED_REALS * 4], DEMI_SIMD_ALIGNMENT ) =
                {
                    x0, y0, z0, 0,
                    x1, y1, z1, 0,
                    x2, y2, z2, 0,
        ...
        */
        inline void loadFromAoS( const float * RESTRICT_ALIAS src );
