...
namespace Demi 
{
    ...
    void DiQuat::FromRotationMatrix (const DiMat3& kRot)
    {
        ...
        // article "DiQuat Calculus and Fast Animation".
    ...
    DiRadian DiQuat::getRoll(bool reprojectAxis) const
    {
        if (reprojectAxis)
        {
            ...
            // DiVec3(1.0-(fTyy+fTzz), fTxy+fTwz, fTxz-fTwy);
    ...
    DiRadian DiQuat::getPitch(bool reprojectAxis) const
    {
        if (reprojectAxis)
        {
            ...
            // DiVec3(fTxy-fTwz, 1.0-(fTxx+fTzz), fTyz+fTwx);
    ...
    DiRadian DiQuat::getYaw(bool reprojectAxis) const
    {
        if (reprojectAxis)
        {
            ...
            // DiVec3(fTxz+fTwy, fTyz-fTwx, 1.0-(fTxx+fTyy));
