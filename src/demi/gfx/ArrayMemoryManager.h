...
namespace Demi
{
    ...
    */
    ...
    public:
        ...
        typedef DiVector<ptrdiff_t> PtrdiffVec;
    ...
    protected:
        ...
        typedef DiVector<size_t> SlotsVec; //TODO: Modify for Ogre
    ...
    */
    ...
    public:
        ...
        ObjectDataArrayMemoryManager( uint16 depthLevel, size_t hintMaxNodes, DiNode *dummyNode,
                                        DiTransformUnit *dummyObject, size_t cleanupThreshold=100,
