...
namespace Demi
{
    ...
    @remarks
        ...
        when a new DiTransformUnit was created and when a DiTransformUnit changes RenderQueue.
        @par
    ...
    */
    class DI_GFX_API ObjectMemoryManager : ArrayMemoryManager::RebaseListener
    {
        typedef DiVector<ObjectDataArrayMemoryManager> ArrayMemoryManagerVec;
    ...
    public:
        ...
        */
        ...
        DiCullNode* _getDummyNode() const { return mDummyNode; }

        /** Retrieves a ObjectData pointing to the first DiTransformUnit in the given render queue
        @param outObjectData
            [out] ObjectData with filled pointers to the first DiTransformUnit in this depth
        @param renderQueue
            Current render queue it belongs to.
        @return
            Number of DiTransformUnit in this depth level
        */
